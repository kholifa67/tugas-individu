...
<div class="row">
    <div class="col-lg-6" >  
     ...
     <div class="card-header" style= "background-color:#ff1476">
       <h6 class="m-0 font-weight-bold text-white"><i class="  "></i> Data Project Siswa</h6>
     </div>
        <div class="card-body">
        <table class="table">
                 <thead>
                 ...
                 <tr>
                     ...
                     <td class="text-center">
                         ...
                         <a href="master_p/create/{{ $item->id }}" class="btn btn-sm btn-success btn-circle"><i class="fas fa-plus"> </i></a>   
                     </td>
                 </tr>
                 @endforeach
        </table>
     ...
     <div class="col-lg-6">
        <div class="card shadow mb-4">
          <div class="card-header" style= "background-color:#ff1476">
          <h6 class="m-0 font-weight-bold text-white"><i class=""></i> About Siswa</h6>
          </div>
